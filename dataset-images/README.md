...
This folder is empty because of the large number of images.
...
**NOTE:** Do not use the folder names like `0`, `1`, `2`, etc. The expected folder names must be the full names, like `zero`, `one`, etc.
